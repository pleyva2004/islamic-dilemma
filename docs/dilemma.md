...
| P2 | **Command** | In Muhammad's own time (~610–632 CE) the Quran tells Jews and Christians to *judge by* and *uphold* their own scriptures — present tense, not merely a claim about the past. | Q5:47, Q5:43, Q5:68, Q10:94 |
...
| **Tahrif al-ma'ani** | Corruption of **meaning** — mistranslation, concealment, false interpretation, distorted reading — while the written words may stand. The historically prominent classical lean (al-Tabari, al-Razi). |
...
| **Bayna yadayhi** | "Between the hands" — idiom for what came before / is present. Apologists read it as the physically-present scripture; responders as the reality of prior revelation. |
...
| **Interpolation** | The text-critical sense of "corruption": bounded later scribal additions — e.g. Mark 16:9–20, John 7:53–8:11, the Comma Johanneum (1 John 5:7–8) — to an otherwise recoverable text, not a substituted book. |
...
- **Q5:47** — *Apologists:* a present-tense command in Muhammad's lifetime; you cannot be told to obey
  a book whose text is unreliable. *Responders:* contextual / *ad hominem* — judge rightly by what
  remained authentic; points to the coming prophet (Q7:157, Q61:6), not a standing warranty.
...
- **Q4:46** — *Apologists:* cited for corruption of the Scripture by the People of the Book.
  *Responders:* al-Tabari and al-Razi read this as distorting sense, reading, and placement —
  corruption of meaning (*tahrif al-ma'ani*), not erasing manuscripts.
...
| **Bible** (`Matthew 27`) | [BibleGateway](https://www.biblegateway.com/passage/?search=Matthew%2027&version=NRSVUE) — ecumenical NRSVUE, 200+ versions + Greek/Hebrew | [BibleHub](https://biblehub.com/matthew/27.htm) — Greek/Hebrew interlinear |
