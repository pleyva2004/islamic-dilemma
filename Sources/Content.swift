...
enum AppContent {
    ...
    static let premises: [Premise] = [
        ...
        Premise(number: "2", title: "Command",
                body: "In Muhammad's own time (~610–632 CE) the Quran tells Jews and Christians to judge by and uphold their own scriptures. This is present tense, not merely a claim about the past.",
    ...
    static let verses: [Verse] = [
        ...
        Verse(ref: "Q5:47", cluster: .affirmation, paraphrase: "So let the People of the Gospel judge by what Allah has revealed therein.", role: "Premise 2 · central text", keyTerm: nil, crossRefs: ["Q5:43", "Q5:68", "Q7:157", "Q61:6"], hinge: true,
              ...
              responder: "Read as contextual or ad hominem: judge rightly by what remained authentic and it points to the coming prophet (cf. Q7:157, Q61:6), not a standing warranty on the whole canon."),
        ...
        Verse(ref: "Q4:157", cluster: .contested, paraphrase: "They did not kill him nor crucify him, but it was made to appear so to them.", role: "the claim the intact Bible contradicts", keyTerm: nil, crossRefs: ["Matthew 27", "Mark 15", "Luke 23", "John 19"], hinge: true,
              apologist: "Horn B: an intact 7th-century Bible teaches the crucifixion in the Gospel accounts (Matthew 27, Mark 15, Luke 23, John 19), directly contradicting this verse, plus Jesus's divinity and sonship.",
    ...
    static let glossary: [GlossaryTerm] = [
        GlossaryTerm(term: "Tahrif", definition: "Distortion / alteration. It splits into two doctrines below, and which one the Quran's ‘distortion’ verses assert is the disputed hinge of the whole debate."),
        ...
        GlossaryTerm(term: "Bayna yadayhi", definition: "‘Between the hands,’ an idiom for what came before or is present. Apologists read it as the physically-present scripture; responders as the reality of prior revelation."),
